        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {popularArticles.map((article, index) => {
            ...
            return (
              <button
                key={index}
                className="bg-white border border-slate-200 rounded-xl p-6 text-left hover:border-blue-500 hover:shadow-lg transition-all group"
              >
                <div className="flex items-start gap-4">
                  <div className="h-12 w-12 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-500 transition-colors">
